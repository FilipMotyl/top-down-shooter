...
public class GameManager : MonoBehaviour
{
    ...
    public TextMeshProUGUI onCanvasScoreText;
    public TextMeshProUGUI onCanvasRifleAmmoText;
    //Start Game Prefabs
    ...
    private void Update()
    {
        ...
        if (player != null)
        {
            onCanvasScoreText.text = finalScore.ToString();
            onCanvasRifleAmmoText.text = player.weaponHolder.GetChild(1).GetComponent<Rifle>().bulletsLeft.ToString();
